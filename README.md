...
`OBJETIVO ODS:` > (2) Fome Zero e Agricultura Sustentável: garantir a segurança alimentar, acabando com a fome e promovendo sistemas alimentares sustentáveis. (12) Consumo e Produção Responsáveis: promove o consumo e a produção responsáveis, incluindo o uso eficiente de recursos naturais.

## Participantes

Os membros do grupo são: 
- Alex Prieto Garbazza Ferraz
- Bruno Henrique Guedes da Cruz
